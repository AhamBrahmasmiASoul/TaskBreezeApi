...
class TokenAuthentication(BaseAuthentication):
    def authenticate(self, request):
        ...
        try:
            ...
            # Fetch the associated CustomUser object from MobileRegistration via the userEmailLinked field
            print("email_id_registration.id: ", email_id_registration.id)
            user = CustomUser.objects.get(userEmailLinked=email_id_registration.id)
