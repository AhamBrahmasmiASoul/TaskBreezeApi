# Generated by Django 5.1.3 on 2025-02-17 00:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=datetime.datetime(2025, 2, 17, 0, 9, 22, 117032, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('i_qty', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ...
                ('created_by_google_auth_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='expense_created_by_google_auth_user', to=settings.AUTH_USER_MODEL)),
                ('created_by_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='expense_created_by_user', to='rajneehsoulapiapp.emailidregistration')),
            ],
        ),
        migrations.CreateModel(
            name='GroupExpense',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastScheduleOn', models.CharField(default='17-02-2025 05:37:22 AM', max_length=200)),
